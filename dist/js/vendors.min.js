...
jQuery(document).ready(function($){
	function productsTable( element ) {
		...
		this.productsWrapper = this.table.children('.comparison--items');
		this.tableColumns = this.productsWrapper.children('.comparison--cols');
		...
		this.navigation = this.table.children('.comparison--nav');
		// bind table events
		this.bindEvents();
	}
	...
	$('.block--comparison').each(function(){
		//create a productsTable object for each .block--comparison
	...
	//detect window resize - reset .block--comparison properties
